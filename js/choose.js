...
let page1 = document.querySelector('.modal__img1b');
let themeButton1 = document.querySelector('#btn1')

btn1.onclick = function () {
  page1.classList.toggle('modal__img1b2');
}

let page2 = document.querySelector('.modal__img1a');
let themeButton2 = document.querySelector('#btn2');

btn2.onclick = function () {
  page2.classList.toggle('modal__img1a2');
};


let page3 = document.querySelector('.modal__img2a');
let themeButton3 = document.querySelector('#btn3');

btn3.onclick = function(){
  page3.classList.toggle('modal__img2a2');
}
